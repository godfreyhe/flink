...
public class BatchMultipleInputOperatorFactory extends AbstractStreamOperatorFactory<RowData> {
	...
	public BatchMultipleInputOperatorFactory(
			int numberOfInputs,
	...
	public <T extends StreamOperator<RowData>> T createStreamOperator(StreamOperatorParameters<RowData> parameters) {
		return (T) new BatchMultipleInputOperator(
			parameters,
			numberOfInputs,
	...
	public Class<? extends StreamOperator> getStreamOperatorClass(ClassLoader classLoader) {
		return BatchMultipleInputOperator.class;
	}
}
