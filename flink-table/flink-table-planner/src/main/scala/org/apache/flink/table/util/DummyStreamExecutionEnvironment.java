...
/**
 * This is dummy {@link StreamExecutionEnvironment}, only used for {@link Planner#explain(List, boolean)} method.
 *
 ...
 *
 * <p>{@link Planner#explain(List, boolean)} method will not only print logical plan but also execution plan,
