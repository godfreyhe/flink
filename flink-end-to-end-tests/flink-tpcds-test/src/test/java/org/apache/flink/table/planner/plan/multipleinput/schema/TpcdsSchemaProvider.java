...
package org.apache.flink.table.planner.plan.multipleinput.schema;
...
public class TpcdsSchemaProvider {
	...
	private static Map<String, TpcdsSchema> createTableSchemas() {
		...
		schemaMap.put("call_center", new TpcdsSchema(Arrays.asList(
				...
				new Column("cc_rec_start_date", DataTypes.DATE().bridgedTo(Date.class)),
				new Column("cc_rec_end_date", DataTypes.DATE().bridgedTo(Date.class)),
		...
		schemaMap.put("item", new TpcdsSchema(Arrays.asList(
				...
				new Column("i_rec_start_date", DataTypes.DATE().bridgedTo(Date.class)),
				new Column("i_rec_end_date", DataTypes.DATE().bridgedTo(Date.class)),
		...
		schemaMap.put("store", new TpcdsSchema(Arrays.asList(
				...
				new Column("s_rec_start_date", DataTypes.DATE().bridgedTo(Date.class)),
				new Column("s_rec_end_date", DataTypes.DATE().bridgedTo(Date.class)),
		...
		schemaMap.put("web_page", new TpcdsSchema(Arrays.asList(
				...
				new Column("wp_rec_start_date", DataTypes.DATE().bridgedTo(Date.class)),
				new Column("wp_rec_end_date", DataTypes.DATE().bridgedTo(Date.class)),
		...
		schemaMap.put("web_site", new TpcdsSchema(Arrays.asList(
				...
				new Column("web_rec_start_date", DataTypes.DATE().bridgedTo(Date.class)),
				new Column("web_rec_end_date", DataTypes.DATE().bridgedTo(Date.class)),
